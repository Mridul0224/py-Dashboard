...
df['Date'] = pd.to_datetime(df['Date'], format='mixed', errors='coerce') # convert the 'Date' column to a datetime object
...
template = pn.template.FastListTemplate(
    ...
    sidebar=[
        ...
        pn.pane.PNG('vecteezy_pack-of-dollars-money-clipart-design-illustration_9303600.png', sizing_mode='scale_both'),
        pn.pane.Markdown(""),
        pn.pane.Markdown(""),
        select_category1
    ],
